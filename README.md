...
a live version of this example can be viewed [in the browser console](https://cdn.rawgit.com/ZenyWay/opgp-service/v2.2.0/spec/example/index.html),
...
* run the [unit tests](https://cdn.rawgit.com/ZenyWay/opgp-service/v2.2.0/spec/web/index.html)
in your browser,
